...
class AddRadiologyTestModal extends StatefulWidget {
  final PatientDiagnosisModel diagnosis;
  const AddRadiologyTestModal({
    Key? key,
    required this.diagnosis,
  }) : super(key: key);

  @override
  State<AddRadiologyTestModal> createState() => _AddRadiologyTestModalState();
}

class _AddRadiologyTestModalState extends State<AddRadiologyTestModal> {
