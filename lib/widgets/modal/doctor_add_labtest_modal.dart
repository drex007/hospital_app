...
class AddLabTestModal extends StatefulWidget {
  final PatientDiagnosisModel diagnosis;
  const AddLabTestModal({Key? key, required this.diagnosis}) : super(key: key);

  @override
  State<AddLabTestModal> createState() => _AddLabTestModalState();
}

class _AddLabTestModalState extends State<AddLabTestModal> {
