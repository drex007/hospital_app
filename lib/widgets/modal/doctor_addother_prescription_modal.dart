...
class AddOtherPrescriptionModal extends StatefulWidget {
  final PatientDiagnosisModel diagnosis;
  const AddOtherPrescriptionModal({
    Key? key,
    required this.diagnosis,
  }) : super(key: key);

  @override
  State<AddOtherPrescriptionModal> createState() =>
      _AddOtherPrescriptionModalState();
}

class _AddOtherPrescriptionModalState extends State<AddOtherPrescriptionModal> {
  ...
  Widget build(BuildContext context) {
    Future submitHandler() {
      ...
      // print(data);
      return _doctorServices.addOtherPrescription(data);
    }
